...
export async function generateMetadata({
  ...
  const news = await getPublishedNewsById(id, "en");
  if (!news) return {};
...
export default function EnNewsDetailsPage(props: { params: Promise<{ id: string }> }) {
  return <NewsDetailsView {...props} basePath="/en" />;
}
