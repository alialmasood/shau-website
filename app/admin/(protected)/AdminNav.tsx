  ...
  return (
    <nav className="flex flex-wrap items-stretch gap-3">
        ...
        {menuOpen && (
          <>
            ...
            <div className="absolute start-4 end-4 mt-1 z-50 rounded-xl border border-neutral-200 bg-white shadow-lg overflow-hidden flex flex-col gap-1 p-2">
              ...
              <NavLink href="/admin/results" variant="secondary" active={isActive(pathname, "/admin/results")} fullWidth compact title="إدارة نتائج الطلاب" icon={<svg className={iconClsSm} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>}>إدارة النتائج</NavLink>
              <NavLink href="/admin/grades" variant="secondary" active={isActive(pathname, "/admin/grades")} fullWidth compact title="إدارة درجات الطلاب" icon={<svg className={iconClsSm} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H7l-4 4V7a2 2 0 012-2z" /></svg>}>إدارة الدرجات</NavLink>
              <NavLink href="/admin/accounts" variant="secondary" active={isActive(pathname, "/admin/accounts")} fullWidth compact title="إدارة الحسابات المالية" icon={<svg className={iconClsSm} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>}>الحسابات</NavLink>
              <NavLink href="/admin/student-accounts" variant="secondary" active={isActive(pathname, "/admin/student-accounts")} fullWidth compact title="إدارة حسابات تسجيل دخول الطلاب" icon={<svg className={iconClsSm} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>}>حسابات الطلاب</NavLink>
              <NavLink href="/admin/student-id" variant="secondary" active={isActive(pathname, "/admin/student-id")} fullWidth compact title="إدارة هويات الطلبة" icon={<svg className={iconClsSm} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h10m-9 4h8m-9 4h6M5 7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7z" /></svg>}>هويات الطلبة</NavLink>
            </div>
          </>
        )}
      </div>
      ...
      <div className="hidden md:grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* المجموعة 1 – المحتوى */}
        <div className="rounded-xl border border-neutral-200 bg-white px-4 py-3 shadow-sm w-full">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white px-4 py-3 shadow-sm w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <NavLink href="/admin/results" variant="secondary" active={isActive(pathname, "/admin/results")} title="إدارة نتائج الطلاب" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>}>إدارة النتائج</NavLink>
            <NavLink href="/admin/grades" variant="secondary" active={isActive(pathname, "/admin/grades")} title="إدارة درجات الطلاب" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H7l-4 4V7a2 2 0 012-2z" /></svg>}>إدارة الدرجات</NavLink>
            <NavLink href="/admin/accounts" variant="secondary" active={isActive(pathname, "/admin/accounts")} title="إدارة الحسابات المالية" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>}>الحسابات</NavLink>
            <NavLink href="/admin/student-accounts" variant="secondary" active={isActive(pathname, "/admin/student-accounts")} title="إدارة حسابات تسجيل دخول الطلاب" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>}>حسابات الطلاب</NavLink>
            <NavLink href="/admin/student-id" variant="secondary" active={isActive(pathname, "/admin/student-id")} title="إدارة هويات الطلبة" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h10m-9 4h8m-9 4h6M5 7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7z" /></svg>}>هويات الطلبة</NavLink>
            <NavLink href="/admin/staff-identity" variant="secondary" active={isActive(pathname, "/admin/staff-identity")} title="طلبات هوية الكادر التدريسي" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /></svg>}>هويات الكادر</NavLink>
            <NavLink href="/admin/employee-identity" variant="secondary" active={isActive(pathname, "/admin/employee-identity")} title="طلبات هوية الموظفين" icon={<svg className={iconCls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>}>هويات الموظفين</NavLink>
          </div>
        </div>
      </div>
    </nav>
