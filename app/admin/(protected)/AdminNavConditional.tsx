...
const allNavItems = [
  ...
  {
    href: "/admin/employee-identity",
    label: "هويات الموظفين",
    pageCode: "employee-identity",
    variant: "secondary" as const,
    title: "طلبات هوية الموظفين",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    label: "مؤتمر الابتكار",
    pageCode: "innovation-conference",
    variant: "secondary" as const,
    title: "طلبات مؤتمر الابتكار 2026",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
