...
import { getShareablePdfUrl } from "./actions";
                    ...
                    <div className="grid grid-cols-2 gap-2 md:flex md:gap-2">
                      ...
                      <button
                        onClick={async () => {
                          ...
                          const attemptNumber = (selectedAttempt === "الدور الثاني" ? 2 : 1) as 1 | 2;
                          const res = await getShareablePdfUrl(attemptNumber);
                        ...
                        className="h-11 px-4 rounded-xl bg-[#25D366] text-white text-sm font-bold hover:bg-[#20ba5a] transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                      >
