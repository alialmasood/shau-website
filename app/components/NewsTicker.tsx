...
export default function NewsTicker() {
  return (
    <div 
      ...
      style={{ direction: "rtl" }}
    >
      <div className="flex items-center gap-6 animate-scroll-rtl">
        {/* تكرار الأخبار عدة مرات لضمان حركة مستمرة */}
        {[...newsItems, ...newsItems, ...newsItems].map((news, index) => (
          <div key={index} className="flex items-center gap-6 whitespace-nowrap flex-shrink-0">
            <span className="text-sm font-medium px-4">{news}</span>
