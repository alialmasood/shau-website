...
export default function ContactSection() {
  ...
  return (
    <section className="relative w-full min-h-[600px] md:h-[800px] lg:h-[900px] overflow-x-hidden flex flex-col md:block" style={{ marginBottom: 0, paddingBottom: 0, marginTop: 0 }}>
      {/* الخريطة - موبايل: تحت الفورم، ديسكتوب: خلفية — تغطي كامل الارتفاع */}
      <div className="relative z-0 w-full h-[300px] md:absolute md:inset-0 md:h-full order-2 md:order-none">
        <iframe
      ...
      <div className="relative z-20 w-full flex flex-col md:absolute md:inset-0 md:flex md:items-center md:justify-start px-4 sm:px-6 lg:px-8 py-6 md:py-12 lg:py-16 xl:py-20 pointer-events-none order-1 md:order-none">
        {/* خانة الفورم */}
        <div className="w-full md:max-w-xs md:mr-auto md:ml-0 mb-4 md:mb-0 pointer-events-auto">
          <div className="bg-white md:bg-white/20 backdrop-blur-md md:backdrop-blur-md rounded-xl shadow-2xl border-2 border-white md:border-white/30 p-5 md:p-6 w-full flex flex-col">
            {/* العنوان */}
