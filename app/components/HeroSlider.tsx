    ...
    <div className="relative w-full h-[52vh] md:h-[600px] lg:h-[700px] overflow-hidden">
      ...
      >
        <div className="space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6">
          ...
          <p
            className={`text-white text-2xl md:text-4xl lg:text-5xl font-bold leading-tight ${
              isEn ? "text-left" : "text-right"
            } -mt-2 md:-mt-3`}
          >
            {t.h1}
      ...
      <div className="absolute left-4 top-1/2 transform -translate-y-1/2 z-30 flex flex-col items-center gap-2">
        ...
        >
          <svg
            className="w-4 h-4 text-white group-hover:text-[#31BD9C] group-hover:scale-110 transition-all duration-300"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
