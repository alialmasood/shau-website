              ...
              <div className="flex flex-wrap justify-center lg:justify-end gap-1.5">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-neutral-800 hover:bg-[#31BD9C] text-neutral-400 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg"
