...
const CONTACT_TEXT = {
  ar: {
    mailSubject: "استفسار — مؤتمر SICIC 2026",
    whatsapp:
      "مرحباً، أود التواصل مع إدارة مؤتمر الشرق للابتكار والإبداع SICIC 2026",
  },
  en: {
    mailSubject: "Inquiry — SICIC 2026 Conference",
    whatsapp:
      "Hello, I would like to contact the management of the Al-Sharq Conference on Innovation & Creativity SICIC 2026",
  },
} as const;
...
type CardItem = { title: string; description: string; icon: IconName };
...
type LandingCopy = {
  ...
  partners: {
    ...
    heading: string;
    lead: string;
    organizations: { name: string; src: string }[];
    sponsorTitle: string;
    sponsorLead: string;
    whatsapp: string;
    email: string;
...
const CONTENT: Record<Locale, LandingCopy> = {
  ar: {
    hero: {
      imageAlt: "مؤتمر الشرق الدولي الأول للابتكار والإبداع 2026 — SICIC 2026",
      titleLine1: "مؤتمر الشرق الدولي الأول",
      titleAccent: "للابتكار والإبداع",
      titleYear: " 2026",
      tagline: "نبتكر اليوم... لنصنع حلول الغد",
      date: "25 تشرين الأول 2026",
      venue: "رحاب كلية الشرق التقنية الطبية الأهلية",
      city: "البصرة / العراق",
      ctaRegister: "سجل ابتكارك",
      ctaAbout: "تعرف على المؤتمر",
    },
    about: {
      eyebrow: "رؤية تبدأ من فكرة",
      heading: "عن المؤتمر",
      body: "يجمع مؤتمر الشرق الدولي الأول للابتكار والإبداع 2026 العقول الشابة والمبدعين والخبراء والمؤسسات، لعرض المشاريع الواعدة وتحويلها إلى حلول تخدم المجتمع. نسعى لأن يكون منصة سنوية لاكتشاف الطاقات وربطها بالفرص والخبرات الداعمة.",
      cta: "اكتشف رؤية المؤتمر",
      pills: [
        ["منصة للمبتكرين", "spark"],
        ["شراكات واسعة", "people"],
        ["مستقبل أفضل", "leaf"],
      ],
      videoTitle: "فيديو عن مؤتمر الشرق الدولي للابتكار والإبداع",
      videoFallback: "أضف رابط فيديو يوتيوب لعرضه هنا",
    },
    goals: {
      eyebrow: "لماذا هذا المؤتمر؟",
      heading: "أهداف المؤتمر",
      lead: "نبني جسراً بين الفكرة والفرصة، وبين المبتكر والجهة القادرة على دعمه.",
      items: [
        {
          title: "دعم الابتكار والإبداع",
          description: "اكتشاف الطاقات الشبابية وتشجيع تطوير الأفكار الواعدة.",
          icon: "spark",
        },
        {
          title: "ربط المبتكرين بالمؤسسات والخبراء",
          description: "فتح قنوات تواصل مع الجامعات والجهات الداعمة والقطاع الخاص.",
          icon: "people",
        },
        {
          title: "تقديم حلول لمشكلات المجتمع",
          description: "تشجيع الابتكارات القابلة للتطبيق وذات الأثر الحقيقي.",
          icon: "leaf",
        },
        {
          title: "تعزيز التعاون العلمي",
          description: "بناء شراكات محلية وعربية ودولية في مجالات الابتكار.",
          icon: "digital",
        },
      ],
    },
    fields: {
      eyebrow: "مجالات واسعة... وفرص أكبر",
      heading: "مجالات الابتكار",
      lead: "نستقبل المشاريع والابتكارات ضمن مجالات متنوعة تفتح المجال أمام الأفكار التي تصنع فرقاً حقيقياً.",
      items: [
        {
      ...
      featuredNote: "فكرتك قد تكون المجال القادم.",
      featuredCta: "استكشف المجال",
      cardCta: "استكشف",
    },
    participants: {
      eyebrow: "من لديه فكرة... له مكان هنا",
      heading: "من يمكنه المشاركة؟",
      lead: "المشاركة مفتوحة أمام مختلف الفئات من الشباب والطلبة والمبتكرين، سواء كانت الفكرة فردية أو ضمن فريق.",
      teamNote: "يمكن المشاركة بصورة فردية أو ضمن فريق من 2–4 أعضاء.",
      items: [
        {
    ...
    info: {
      eyebrow: "موعدنا في البصرة",
      heading: "معلومات المؤتمر",
      lead: "يوم يجمع الأفكار والمبتكرين والخبراء في رحاب كلية الشرق التقنية الطبية الأهلية.",
      rows: [
      ...
      ctaProgram: "البرنامج التفصيلي",
      imageAlt: "إبداع مؤتمر الشرق للابتكار والإبداع",
    },
    journey: {
      eyebrow: "من الفكرة إلى منصة العرض",
      heading: "رحلة المشارك",
      lead: "خمس مراحل واضحة تبدأ بتسجيل المشروع وتنتهي بعرض الابتكار أمام لجنة التحكيم والجمهور.",
      badge: "رحلة واحدة • خمس مراحل",
      items: [
        {
      ...
      footer: "والخطوة التالية... منصة التتويج",
    },
    partners: {
      eyebrow: "معاً نصنع الأثر",
      heading: "الرعاة والشركاء",
      lead: "يجري التنسيق مع مجموعة من المؤسسات الأكاديمية والاقتصادية والجهات الداعمة للمشاركة في دعم المؤتمر وفعالياته.",
      organizations: [
      ...
      sponsorTitle: "مهتم برعاية المؤتمر أو الشراكة معنا؟",
      sponsorLead: "تواصل مع إدارة المؤتمر عبر واتساب أو البريد الإلكتروني",
      whatsapp: "واتساب",
      email: "بريد إلكتروني",
    },
    faq: {
      eyebrow: "إجابات على أهم استفساراتك",
      heading: "الأسئلة الشائعة",
      lead: "معلومات سريعة حول المشاركة والتسجيل وشروط التقديم في المؤتمر.",
      questions: [
        [
    ...
    finalCta: {
      eyebrow: "الفكرة تبدأ منك",
      heading: "كن جزءاً من مستقبل الابتكار",
      lead: "سجّل ابتكارك وشارك في مؤتمر الشرق الدولي الأول للابتكار والإبداع 2026، وكن ضمن منصة تجمع المبدعين والخبراء والمؤسسات الداعمة.",
      ctaRegister: "سجّل ابتكارك",
      ctaAbout: "تعرف على المؤتمر",
      note: "25 تشرين الأول 2026 • كلية الشرق التقنية الطبية الأهلية • البصرة",
    },
  },
  ...
  en: {
    hero: {
      imageAlt:
        "First Al-Sharq International Conference on Innovation & Creativity 2026 — SICIC 2026",
      titleLine1: "First Al-Sharq International Conference",
      titleAccent: "on Innovation & Creativity",
      titleYear: " 2026",
      tagline: "Innovate today... to build tomorrow's solutions",
      date: "25 October 2026",
      venue: "Al-Sharq Private Medical Technical College",
      city: "Basra / Iraq",
      ctaRegister: "Register your innovation",
      ctaAbout: "About the conference",
    },
    about: {
      eyebrow: "A vision that starts with an idea",
      heading: "About the Conference",
      body: "The First Al-Sharq International Conference on Innovation & Creativity 2026 brings together young minds, creators, experts and institutions to showcase promising projects and turn them into solutions that serve the community. Our aim is an annual platform that discovers talent and connects it with opportunities and supportive expertise.",
      cta: "Discover the conference vision",
      pills: [
        ["A platform for innovators", "spark"],
        ["Wide partnerships", "people"],
        ["A better future", "leaf"],
      ],
      videoTitle: "Video about the Al-Sharq International Conference on Innovation & Creativity",
      videoFallback: "Add a YouTube video link to display it here",
    },
    goals: {
      eyebrow: "Why this conference?",
      heading: "Conference Objectives",
      lead: "We build a bridge between the idea and the opportunity, and between the innovator and those able to support them.",
      items: [
        {
          title: "Supporting innovation and creativity",
          description: "Discovering young talent and encouraging the development of promising ideas.",
          icon: "spark",
        },
        {
          title: "Connecting innovators with institutions and experts",
          description:
            "Opening channels with universities, supporting bodies and the private sector.",
          icon: "people",
        },
        {
          title: "Delivering solutions to community problems",
          description: "Encouraging applicable innovations with genuine impact.",
          icon: "leaf",
        },
        {
          title: "Strengthening scientific cooperation",
          description: "Building local, regional and international partnerships in innovation.",
          icon: "digital",
        },
      ],
    },
    fields: {
      eyebrow: "Broad tracks... bigger opportunities",
      heading: "Innovation Tracks",
      lead: "We welcome projects and innovations across diverse tracks that open the door to ideas making a real difference.",
      items: [
        {
          title: "Medical and Health Innovation",
          description:
        ...
        {
          title: "Engineering, Robotics and Automation",
          description:
            "Engineering and robotics innovations, control systems and scalable automation.",
          icon: "engineering",
        },
        {
          title: "Energy, Oil and Gas",
          description:
            "Innovative solutions for energy, the petroleum industry, operational efficiency and sustainability.",
          icon: "energy",
        },
        {
          title: "Environment and Sustainability",
          description:
            "Ideas that address environmental, water and waste challenges and build a more sustainable future.",
          icon: "leaf",
        },
        {
          title: "Community and Public Service Innovation",
          description:
            "Innovative solutions that improve education, services and quality of life and tackle community challenges.",
          icon: "people",
        },
        {
        ...
        },
        {
          ...
          description:
            "Inventions, prototypes and projects with technical value and strong development potential.",
          icon: "patent",
        },
        {
          title: "Open Track for Innovation and Creativity",
          description:
            "Have an innovative idea that does not fit a specific track? This track is open to the different ideas that deserve to see the light.",
          icon: "spark",
        },
      ],
      featuredNote: "Your idea could be the next track.",
      featuredCta: "Explore the track",
      cardCta: "Explore",
    },
    participants: {
      eyebrow: "If you have an idea, you have a place here",
      heading: "Who can participate?",
      lead: "Participation is open to a wide range of young people, students and innovators, whether the idea is individual or developed by a team.",
      teamNote: "You can take part individually or as a team of 2–4 members.",
      items: [
        {
          title: "Secondary school students",
          description: "For students with creative ideas or projects that can be developed further.",
          icon: "spark",
        },
        {
          title: "University, college and institute students",
          description: "For student projects and academic and technical innovations.",
          icon: "engineering",
        },
        {
          title: "Graduates and youth",
          description: "For those with promising ideas, initiatives and projects.",
          icon: "people",
        },
        {
          title: "Independent innovators and inventors",
          description: "For owners of inventions, prototypes and technical solutions.",
          icon: "digital",
        },
        {
          title: "Researchers",
          description:
            "For those with research results or solutions that can become practical applications.",
          icon: "patent",
        },
        {
          title: "Entrepreneurs and initiative leaders",
          description:
            "For projects that combine innovation with the ability to grow and be applied.",
          icon: "business",
        },
      ],
    },
    info: {
      eyebrow: "See you in Basra",
      heading: "Conference Information",
      lead: "A day that brings together ideas, innovators and experts on the campus of Al-Sharq Private Medical Technical College.",
      rows: [
        ["Date", "25 October 2026", "calendar"],
        ["Venue", "Al-Sharq Medical Technical College", "pin"],
        ["City", "Basra / Iraq", "users"],
        ["Duration", "One day", "clock"],
      ],
      ctaRegister: "Register your innovation",
      ctaProgram: "Detailed programme",
      imageAlt: "Creativity at the Al-Sharq Conference on Innovation & Creativity",
    },
    journey: {
      eyebrow: "From the idea to the exhibition stage",
      heading: "The Participant's Journey",
      lead: "Five clear stages that begin with registering the project and end with presenting the innovation before the judging panel and the audience.",
      badge: "One journey • Five stages",
      items: [
        {
          title: "Online registration",
          description:
            "Complete the participation form, enter the project and team details and upload the required attachments.",
          icon: "patent",
        },
        {
          title: "Initial review",
          description:
            "Screening the application and confirming that participation requirements and core information are complete.",
          icon: "check",
        },
        {
          title: "Scientific evaluation",
          description:
            "Specialists assess the project against innovation, impact and feasibility criteria.",
          icon: "digital",
        },
        {
          title: "Acceptance for exhibition",
          description:
            "Qualified projects are notified, participation requirements are completed and exhibition space is prepared.",
          icon: "award",
        },
        {
          title: "Presentation at the conference",
          description:
            "Present the innovation to the judges, participating organizations and the audience during the conference day.",
          icon: "spark",
        },
      ],
      footer: "And the next step... the winners' stage",
    },
    partners: {
      eyebrow: "Together we make an impact",
      heading: "Sponsors and Partners",
      lead: "Coordination is under way with a group of academic and economic institutions and supporting bodies to take part in supporting the conference and its activities.",
      organizations: [
        { name: "National Bank of Iraq", src: "/ahli.png" },
        { name: "Swech Electronic Payment Company", src: "/swech.png" },
        { name: "Basra Oil Company", src: "/poc.png" },
        { name: "Zain Iraq", src: "/zain.png" },
        { name: "University of Basrah", src: "/uob-logo.png" },
        { name: "Canadian Science Organization", src: "/cso.png" },
        { name: "Ministry of Higher Education and Scientific Research", src: "/mohesr.png" },
        {
          name: "American Group for Consulting, Conferences and Training",
          src: "/imno.png",
        },
      ],
      sponsorTitle: "Interested in sponsoring the conference or partnering with us?",
      sponsorLead: "Contact the conference management via WhatsApp or email",
      whatsapp: "WhatsApp",
      email: "Email",
    },
    faq: {
      eyebrow: "Answers to your key questions",
      heading: "Frequently Asked Questions",
      lead: "Quick information about participation, registration and application requirements.",
      questions: [
        [
          "Who can take part in the conference?",
          "Participation is open to school and university students, graduates, young people, innovators, inventors, researchers and entrepreneurs, either individually or as a team.",
        ],
        [
          "Are there participation fees?",
          "All registration details and participation conditions will be announced when applications officially open.",
        ],
        [
          "Can I take part as a team?",
          "Yes. You may take part individually or as a team of 2 to 4 members.",
        ],
        [
          "Do I need to hold a patent?",
          "No. The conference accepts advanced innovative ideas, prototypes and applicable projects, as well as registered or pending inventions.",
        ],
        [
          "When does registration close?",
          "The opening and closing dates for registration will be announced officially when the application platform launches.",
        ],
        [
          "Do participants receive certificates?",
          "Owners of accepted projects who take part in the conference activities receive official participation certificates.",
        ],
      ],
    },
    finalCta: {
      eyebrow: "The idea starts with you",
      heading: "Be part of the future of innovation",
      lead: "Register your innovation and take part in the First Al-Sharq International Conference on Innovation & Creativity 2026, joining a platform that brings together creators, experts and supporting institutions.",
      ctaRegister: "Register your innovation",
      ctaAbout: "About the conference",
      note: "25 October 2026 • Al-Sharq Private Medical Technical College • Basra",
    },
  },
};
...
export default function InnovationConferenceLanding({ locale = "ar" }: { locale?: Locale }) {
  const t = CONTENT[locale];
  const dir = locale === "ar" ? "rtl" : "ltr";
  const registerHref = `/${locale}/innovation-conference/register`;
  const contact = CONTACT_TEXT[locale];

  const mailtoHref = `mailto:${IC_CONTACT_EMAIL}?subject=${encodeURIComponent(contact.mailSubject)}`;
  const whatsappHref = IC_CONTACT_WHATSAPP
    ? `https://wa.me/${IC_CONTACT_WHATSAPP.replace(/\D/g, "")}?text=${encodeURIComponent(contact.whatsapp)}`
    : null;
  ...
  // العناوين العربية تتسع في سطر واحد على الشاشات المتوسطة؛ الإنجليزية أطول فتُترك قابلة للالتفاف.
  const titleNoWrap = locale === "ar" ? "sm:whitespace-nowrap" : "";
    ...
    <div dir={dir} className="overflow-x-hidden bg-white text-neutral-800">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center px-4 py-16 pb-10 sm:px-6 sm:py-20 sm:pb-12 lg:px-8 lg:py-24 lg:pb-14">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-12 xl:gap-16">
            ...
            <div className="min-w-0 max-w-3xl">
              ...
              >
                <span
                  className={`block text-[1.55rem] leading-snug sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-6xl ${titleNoWrap}`}
                >
                  {t.hero.titleLine1}
                </span>
                <span
                  className={`mt-3 block text-[1.2rem] leading-snug sm:mt-5 sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-5xl ${titleNoWrap}`}
                >
                  <span className="text-[#31BD9C]">{t.hero.titleAccent}</span>
                  <span className="text-white">{t.hero.titleYear}</span>
              ...
              <ul className="mt-6 flex flex-col gap-2.5 text-sm leading-7 text-white/90 sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-6 sm:gap-y-3">
                <li className="flex items-center gap-2">
                  ...
                  <time dateTime="2026-10-25">{t.hero.date}</time>
                </li>
                ...
                <li className="hidden h-4 w-px bg-white/25 sm:block" aria-hidden="true" />
                <li className="flex items-center gap-2 ps-7 sm:ps-0">{t.hero.city}</li>
              </ul>
              ...
              <div className="mt-8 max-w-xl rounded-2xl border border-white/15 bg-[#061528]/45 p-4 shadow-[0_8px_40px_rgba(0,0,0,0.25)] backdrop-blur-md sm:mt-10 sm:p-5">
                <ConferenceCountdown locale={locale} />
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              ...
              <ConferenceHeroCaption locale={locale} />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:items-start lg:gap-4 lg:ps-2 lg:pe-0 xl:gap-5 xl:ps-3">
          ...
          <div className="min-w-0 flex-1 lg:max-w-none">
            <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.about.eyebrow}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-[2rem] bg-[#F2FBF8] px-5 pt-6 pb-10 sm:px-8 sm:pt-7 sm:pb-12 lg:px-12 lg:pt-8 lg:pb-14">
            ...
            <div className="relative mb-8 max-w-2xl sm:mb-10">
              <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.goals.eyebrow}</p>
              <h2
                id="conference-goals"
              ...
              <p className="mt-4 text-sm leading-8 text-neutral-600 sm:text-base">{t.goals.lead}</p>
            </div>
            ...
            <div className="relative grid gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-5">
              {t.goals.items.map((item) => (
                ...
                >
                  ...
                  <h3 className="text-base font-extrabold leading-7 text-[#163364]">{item.title}</h3>
      ...
      <section className="bg-white pt-8 pb-16 sm:pt-10 sm:pb-20 lg:pt-12 lg:pb-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-2xl sm:mb-12">
            <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.fields.eyebrow}</p>
            <h2 className="text-3xl font-extrabold leading-snug text-[#163364] sm:text-4xl lg:text-[2.75rem]">
              {t.fields.heading}
            </h2>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            {t.fields.items.map((field, index) => {
      ...
      >
        ...
        <div className="grid w-full overflow-hidden lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.55fr)]">
          ...
          <div className="flex flex-col justify-center bg-[#1a3a5c] px-6 py-12 text-white sm:px-10 sm:py-14 lg:px-12 lg:py-16 xl:px-16">
            <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.participants.eyebrow}</p>
            <h2
      ...
      >
        <div className="grid w-full overflow-hidden lg:grid-cols-[minmax(0,1.35fr)_minmax(0,0.85fr)]">
          ...
          <div className="relative flex flex-col justify-center overflow-hidden bg-[#163364] px-5 py-8 text-white sm:px-8 sm:py-9 lg:px-10 lg:py-10 xl:px-14">
            ...
            />
            <p className="relative mb-2 text-xs font-bold text-[#31BD9C] sm:text-sm">{t.info.eyebrow}</p>
            <h2
            ...
            <dl className="relative mt-5 grid grid-cols-2 gap-x-4 gap-y-4 sm:max-w-2xl">
              {t.info.rows.map(([label, value, icon]) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-wrap items-end justify-between gap-4 sm:mb-10">
            <div className="max-w-2xl">
              <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.journey.eyebrow}</p>
              <h2 className="text-3xl font-extrabold leading-snug text-[#163364] sm:text-4xl lg:text-[2.75rem]">
                {t.journey.heading}
              </h2>
              <p className="mt-4 text-sm leading-8 text-neutral-600 sm:text-base sm:leading-8">
          ...
          <ol className="relative space-y-6 lg:hidden">
            ...
            />
            {t.journey.items.map((step, index) => (
      ...
      <section className="bg-[#F7FAF9] py-16 sm:py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-8 max-w-2xl text-center sm:mb-10">
            <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.partners.eyebrow}</p>
            <h2 className="text-3xl font-extrabold leading-snug text-[#163364] sm:text-4xl lg:text-[2.75rem]">
              {t.partners.heading}
            </h2>
            <p className="mt-4 text-sm leading-8 text-neutral-600 sm:text-base sm:leading-8">
          ...
          <div className="overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <ul className="mx-auto flex min-w-max items-center justify-center gap-2.5 sm:gap-4 lg:min-w-0 lg:w-full lg:gap-5">
              {t.partners.organizations.map((partner) => (
                <li
                  key={partner.src}
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl items-start gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.4fr] lg:gap-16 lg:px-8">
          <div className="max-w-md">
            <p className="mb-3 text-sm font-bold text-[#31BD9C]">{t.faq.eyebrow}</p>
            <h2 className="text-3xl font-extrabold leading-snug text-[#163364] sm:text-4xl lg:text-[2.75rem]">
              {t.faq.heading}
            </h2>
            <p className="mt-4 text-sm leading-8 text-neutral-600 sm:text-base sm:leading-8">
      ...
      >
        ...
        <div className="relative mx-auto flex min-h-0 w-full max-w-4xl flex-col items-center px-4 py-16 text-center sm:px-6 sm:py-20 lg:min-h-[400px] lg:justify-center lg:py-24">
          <p className="text-sm font-bold text-[#31BD9C]">{t.finalCta.eyebrow}</p>
          <h2
