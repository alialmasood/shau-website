/**
 * تشغيل هجرة تحويل نوع التقديم إلى مصفوفة (apply_types) مع حقول الرابط المنفصلة.
 * الاستخدام: node scripts/run-apply-types-migration.js
 */
...
const migrationPath = path.join(
  ...
  "prisma",
  "migrations",
  "20260124180000_apply_types_array",
  "migration.sql"
);

async function run() {
  console.log("تشغيل هجرة apply_types (أنواع التقديم المتعددة)...\n");
  ...
  console.log("\nتم تطبيق هجرة apply_types بنجاح.");
}
