/**
 * تشغيل هجرة تحويل التصنيف إلى مصفوفة (categories JSONB).
 * الاستخدام: node scripts/run-dept-fee-categories-migration.js
 */
...
const migrationPath = path.join(
  ...
  "prisma",
  "migrations",
  "20260124170000_dept_fee_categories_array",
  "migration.sql"
);

async function run() {
  console.log("تشغيل هجرة categories (التصنيف كمصفوفة)...\n");
  ...
  console.log("\nتم تطبيق هجرة categories بنجاح.");
}
