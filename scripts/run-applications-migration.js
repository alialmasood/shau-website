/**
 * تشغيل هجرة جدول applications (طلبات التقديم).
 * الاستخدام: node scripts/run-applications-migration.js
 */
...
const migrationPath = path.join(__dirname, "..", "prisma", "migrations", "20260125000000_add_applications", "migration.sql");

async function run() {
  console.log("تشغيل هجرة جدول applications...\n");
  ...
  console.log("\nتم تطبيق هجرة applications بنجاح.");
}
